...
public class Dadcinematic : MonoBehaviour
{
  [SerializeField]private GameObject[] dialogueCutsceneArray;
    ...
    private void Awake() {
        SkipButton.onClick.AddListener(() => {
            LoadingScreenScene.LoadScene(LoadingScreenScene.Scene.GortLevel); // ga ini fast forward ke insert disk aja , playerSO.level = 1;
    ...
    void Start()
    {
        ...
        dialogChecker[4].OnDialogueAllDone += dialog5_OnDialogueAllDone;
    ...
    private void dialog4_OnDialogueAllDone(object sender, System.EventArgs e){
        dialogueCutsceneArray[3].SetActive(false);
        dialogueCutsceneArray[4].SetActive(true);
        
    }
    private void dialog5_OnDialogueAllDone(object sender, System.EventArgs e){
